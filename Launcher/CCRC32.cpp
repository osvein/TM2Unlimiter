...
bool CCRC32::FileCRC(const wchar_t *sFileName, unsigned long *ulOutCRC, unsigned long ulBufferSize)
{
    *(unsigned long *)ulOutCRC = 0xffffffff; //Initilaize the CRC.
    ...
    if((fSource = _wfopen(sFileName, L"rb")) == NULL)
    {
...
bool CCRC32::FileCRC(const wchar_t *sFileName, unsigned long *ulOutCRC)
{
